...
CREATE EXTENSION PACKAGE ai VERSION '1.0' {
    ...
    {
        create annotation std::deprecated :=
            "This model is noted as a legacy model in the VoyageAI docs. Consider using voyage-4 instead.";
        alter annotation
    ...
    {
        create annotation std::deprecated :=
            "This model is noted as a legacy model in the VoyageAI docs. Consider using voyage-4-lite instead.";
        alter annotation
    ...
    {
        create annotation std::deprecated :=
            "This model is noted as a legacy model in the VoyageAI docs. Consider using voyage-code-4 instead.";
        alter annotation
    ...
    {
        create annotation std::deprecated :=
            "This model is noted as a legacy model in the VoyageAI docs. Consider using voyage-context-4 instead.";
        alter annotation
